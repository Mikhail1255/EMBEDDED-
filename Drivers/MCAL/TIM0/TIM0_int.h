...
/* Pointer to Function Type for the Callbacks */
...
void TIM0_voidOVSetCallBack(pf OVFunctionAddress); /*[cite: 19]*/
...
void TIM0_voidCTCSetCallBack(pf CTCFunctionAddress); /*[cite: 19]*/
